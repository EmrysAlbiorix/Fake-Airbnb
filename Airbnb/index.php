    ...
    <div class="album py-5 bg-light">
	    ...
	    <form method="get" action="results.php">
            <div class="row g-3 align-items-center">
                ...
                <div class="col-auto">
                    <select name="neighborhood" id="neighborhood" class="form-select" aria-label="Default select example">
        				<?php  echo getNeighborhoods()?>
                    </select>
                </div>
            ...
            <div class="row g-3 align-items-center">
                ...
                <div class="col-auto">
                    <select name="guests" id="guests" class="form-select" aria-label="Default select example">
		    			<!-- php for getting rooms here -->
						<?php echo getGuests()?>
		    		</select>
                </div>
